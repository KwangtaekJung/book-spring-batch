...
import com.example.chapter8.service.EvenFilteringItemProcessor;
...
public class CustomerItemProcessorJob {
    ...
    public Job job() throws Exception {
        return this.jobBuilderFactory.get("customerItemProcessorJob")
                .start(copyFileStep())
    ...
    public static void main(String[] args) {
        SpringApplication.run(CustomerItemProcessorJob.class, "customerFile=/input/customer.csv", "script=/lowerCase.js");
    }
}
